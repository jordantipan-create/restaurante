...
<head>
    ...
    <title>👤 Panel Usuario - Restaurante POS</title>
...
<div class="topbar">
    <div class="logo">
        <span class="icon">🍴</span> Restaurante POS
    </div>
...
<main class="content-wrapper">
    <header class="content-header">
        <h1 id="content-title">🏠 Dashboard Usuario</h1>
        <p id="content-sub">Bienvenido <?php echo htmlspecialchars($usuario); ?>.</p>
    </header>

    <section class="content-frame-container">
        <iframe id="content-frame" src="homeusu.php" frameborder="0"></iframe>
    </section>
</main>

<footer class="footer">
    <p>© 2025 Restaurante POS | Panel Usuario</p>
</footer>
